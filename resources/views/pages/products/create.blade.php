        ...
        <div class="max-w-2xl mx-auto bg-white shadow-lg rounded-2xl p-6 mt-10">
            <form action="{{ route('products.store') }}" method="post" class="space-y-3">
                ...
                <div>
                    ...
                    <input type="text" name="name" placeholder="Digite o nome do produto" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-lime-500 focus:border-lime-500 outline-none transition" />
                </div>
                <div>
