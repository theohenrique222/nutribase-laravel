...
@section('content')
<div style="background-image: url('{{ asset('img/background3.jpg') }}')" class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8 bg-lime-100/10 backdrop-blur-sm p-5 rounded-b-md">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-white">Ou <a href="{{ route('register') }}" class="font-medium text-lime-200 hover:text-lime-500">crie uma nova conta</a></p>
        </div>
